...
namespace mediacore.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(DB_medIAContext context)
        {
            _context = context;
        }
        ...
        {
            var dB_medIAContext = _context.User.Include(u => u.IdGroupNavigation).Include(u => u.IdRoleNavigation);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["IdRole"] = new SelectList(_context.Role, "Id", "Name");
            return View();
        }
