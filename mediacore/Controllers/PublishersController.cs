...
namespace mediacore.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public PublishersController(DB_medIAContext context)
        {
            _context = context;
        }
        ...
        {
            var dB_medIAContext = _context.Publisher.Take(20).Include(p => p.IdPublisherIndicatorNavigation);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var publisher = await _context.Publisher
                .Include(p => p.IdPublisherIndicatorNavigation)
        ...
        {
            ViewData["IdPublisherIndicator"] = new SelectList(_context.PublisherIndicator, "Id", "Id");
            return View();
        }
